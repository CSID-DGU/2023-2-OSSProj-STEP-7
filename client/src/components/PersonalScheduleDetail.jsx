...
var PersonalScheduleDetail = function (_a) {
    var handleModalToggle = _a.handleModalToggle, getApi = _a.getApi, id = _a.id, date = _a.date, event = _a.event;
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 4, , 5]);
                        putData = { title: title, contents: contents, scheduleType: scheduleType, importance: importance, startDate: startDate, endDate: endDate };
                        if (!(startDate < endDate)) return [3 /*break*/, 2];
                        return [4 /*yield*/, Api.put("/schedule/common/".concat(id), putData).then(function (res) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Api.delete("/schedule/common/".concat(id)).then(function (res) {
                            if (date) {
                                var month = date[0], year = date[1];
                                getApi === null || getApi === void 0 ? void 0 : getApi(year, month);
                            }
